...
The zomboid-setup.sh script automatically installs web-lgsm! If it's already installed, you can access it at:
...
Web-LGSM runs on plain HTTP by default. This is fine for:
